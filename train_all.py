...
for fold in range(1,6):
    subprocess.run(f"python retrain.py -c checkpoints/pid_nolorries_retrain_fold_{fold}_dense_checkpoint --fold {fold} --gpu 0 --in-dataset pid --batch-size 32 ", shell=True)